---
name: strategist:reference/act/execution-plan
...
image: assets/execution-plan.png
---
...
The Execution Plan is the right tool whenever a programme has more than one workstream running in parallel over a period longer than a few weeks. It is the activity-level backbone of the Act stage — the document teams return to in every programme review.
...
- [Gantt](../insight/gantt.md) — the Insight-stage equivalent for showing scheduled activity over time; the Execution Plan adapts this logic for the Act stage with goal and workstream structure added.
