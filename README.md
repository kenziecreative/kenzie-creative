...
|---|---|---|---|
| Blueprint | 0.1.1 | Turn how you actually work into a process document an agent could execute, with every step rated for what's safe to automate | [guide](./blueprint/README.md) |
