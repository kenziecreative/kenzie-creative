---
description: Quarterly review — re-score anchors, audit systems, replan, run the recurring pre-mortem.
allowed-tools: Read, Write, Edit, Glob, Grep
---

Run the **quarterly** review.

Use the `goal-setting-review` skill for the **quarterly** cadence and follow its steps exactly.
It **closes out the outgoing quarter first** — every ending Objective gets a disposition
